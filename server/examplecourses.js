testcourses = [{
	...
	'roles': {
		'team':        { subscribed: [ 'greg' ] },
		'participant': { subscribed: [ 'LeOnI', 'IvanZ', 'Barbie92' ] },
		'host':        { subscribed: [ 'greg' ] },
	}
},{
	'name':        'Super 8',
	...
	'roles': {
		'team':        { subscribed: [ 'LeOnI' ] },
		'participant': { subscribed: [ 'LeOnI', 'WAvegetarian' ] },
		'mentor':      { subscribed: [] },
		'host':        { subscribed: [ 'Sandro' ] },
	}
},{
	...
	'roles': {
		'participant': { subscribed: [ 'Scotty Solorio', 'Edith Escudero', 'Willian Wiesner', ' Russel Rowsey', ' Krysta Kabel', ' Zane Zeringue', ' Buena Balling', ' Pablo Petti', ' Ed Epting', ' Mathilda Morita', ' Nevada Nicola', ' Dick Dominguez', ' Marylyn Metoyer', ' September Stubblefield', ' Chastity Capp', ' Mellisa Momon', ' Jack Jordon', ' Yolonda Yoshida', ' Raymundo Rowland', ' Beatrice Bernett'] },
		'mentor':      { subscribed: [ 'Lisa', 'Robi', 'KGut' ] },
		'host':        { subscribed: [ 'ASZ - Bildung für alle' ] },
	}
},{
	'name':        'Deutschkurs',
	'categories': ['Sprache'],
	...
	'roles': {
		'participant': { subscribed: [ 'Maryellen Moyers', 'Otto Oshields', 'Hui Hung', 'Wilhelmina Wolf', 'Lenora Lucca', 'Etha Eis', 'Florence Flavors', 'Kandace Kahn', 'Elaine Elswick', 'Dinorah Duwe', 'Levi Lind', 'Shelba Slinkard', 'Marina Maiden', 'Nickie Nordin', 'Valda Vento', 'Rosalinda Runyan', 'Latrisha Lamon', 'Eartha Ellenburg', 'Irena Ivers', 'Chassidy Cerna', 'Luis Lambrecht', 'Eugena Elling', 'Lavenia Lastrapes', 'Truman Tomson', 'Seth Stall', 'Regena Robey', 'Michel Mancil', 'Lorilee Leftwich', 'Jonah Jaeger', 'Jesica Jeanbart' ] },
		'mentor':      { subscribed: ['KGut', 'Felice Friedt', 'Illa Iser'] },
		'host':        { subscribed: [] },
	}
},{
	'name':        'Deutsch',
	...
	'roles': {
		'participant': { subscribed: [ 'IvanZ', 'BenDe', 'Lucy', 'SeulSoul' ] },
		'host':        { subscribed: [ 'IvanZ' ] },
	}
},{
	'name':        'Jodeln',
	'categories': ['Musik'],
	...
	'roles': {
		'participant': { subscribed: [ 'Sandra', 'HertsPflaschter' ] },
		'mentor':      { optional: true, subscribed: [] }
	}
},{
	...
	'roles': {
		'participant': { subscribed: [ 'OliviaTheMan!!!Yeah <!-- Hack -->', 'HertsPflaschter' ] },
		'host':        { subscribed: [ 'DGass' ] }
	}
},{
	...
	'roles': {
		'participant': { subscribed: [ 'Mao', 'Tse', 'Tung' ] },
		'host':        { subscribed: [ 'Flumsi' ] }
	}
},{
	'name':        'Sprayen Gehen',
	...
	'roles': {
		'participant': { subscribed: [ 'Fuck The Police', '01', 'Eimi', '~UnDeRdOuG~', 'FiggDi', 'Barbie92', 'Mao', 'Sandra', 'FUFZIGRAPPER', '031', 'Vollpfoschte98', 'SchwarzMiFarb' ] }
	}
},{
	'name':        '',
	'categories': ['', ''],
