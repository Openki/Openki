...
testgroups = [{
	...
	'short':            'Denki',
	'claim':            '',
	'description':      'Denk:mal Bern, Lorraine <br> <a href="http://www.denk-mal.info/">denk-mal.info</a>',
	'members':          ['sb','Linda']
	...
	'short':            'DIY-ZH',
	'claim':            '',
	'description':      'We facilitate Do-It-Yourself-initiatives in the area of Zurich',
	'members':          ['Melinda']
},{
	'name':        	    'Wohlfühlgruppe-ZH',
	'short':            'WFG-ZH',
	'claim':            'Alles was gut tut.',
	'description':      'Wir unterstützen Initiativen von einzelpersonen zur Verbesserung des geistigen und körperlichen Wohlergehens.',
	'members':          ['Regula', 'Tiffany', 'Vlada']
},{
	'name':        	    'Geographisch-Ethnographische Gesellschaft Zürich',
	'short':            'GeoUZH',
	'claim':            '',
	'description':      ' <p>Anliegen und Zielsetzungen: <ul> <li> Förderung von geographischem und ethnographischem Wissen <li> Erhaltung der Umwelt und der Qualität unserer Lebensräume Nachhaltige Nutzung unserer Ressourcen <li> Verständnis für fremde Kulturen und globale Zusammenhänge </ul> </p> <p> Die Geographisch-Ethnographische Gesellschaft Zürich (GEGZ) kann auf eine rund hundertjährige Geschichte zurückblicken. Sie entstand 1899 durch den Zusammenschluss der Ethnographischen Gesellschaft (gegründet 1888) und der Geographischen Gesellschaft (gegründet 1897). Durch die Förderung der Völkerkundlichen Sammlung (die später an die Universität übergeben wurde und im heutigen Völkerkundemuseum weiterlebt), die Organisation von vielbeachteten Vorträgen, die Publikation von Aufsätzen und die Durchführung von Exkursionen hat sie sich einen Namen gemacht, der weit über Zürich hinaus reicht.<br /><br /> Die GEGZ setzt sich für die Förderung und Verbreitung von geographischem und ethnographischem Wissen ein. Die Geographie beschäftigt sich heute mit verschiedenen gesellschaftlich relevanten Themen, wie Umweltschutz, nachhaltiger Umgang mit natürlichen und gesellschaftlichen Ressourcen, Klimawandel, Raumplanung, Probleme der Entwicklungsländer bis zu Aspekten der Globalisierung von Wirtschaft und Kultur. Geographisches Wissen und darauf aufbauendes Handeln ist für die Lösung globaler Herausforderungen und somit für die Zukunft unserer Gesellschaft von wachsender Bedeutung. <br /><br />Die GEGZ sieht sich als Bindeglied zwischen Hochschule und Öffentlichkeit. Ihr Hauptanliegen ist es, durch Fachvorträge und Exkursionen wissenschaftliche Forschungsergebnisse in verständlicher Form an einen breiten Personenkreis weiterzugeben. Eine weitere Aufgabe ist die Förderung der geographischen und ethnographischen Wissenschaften an unseren Hochschulen.<br /><br />Die Gesellschaft zählt zur Zeit über 450 Einzel- und Kollektivmitglieder. Ein grosser Teil der Mitglieder sind Geographen und Geographinnen, viele Mitglieder sind im Lehramt aller Stufen tätig, andere arbeiten in der öffentlichen Verwaltung, der Privatwirtschaft oder studieren.<br /><br />Die GEGZ ist Mitherausgeberin der Geographica Helvetica (GH). Diese schweizerische Fachzeitschrift für Geographie bietet den Lesern und Leserinnen einen fundierten Einblick in das breite Spektrum der geographischen Forschung. Diese Zeitschrift, die vierteljährlich erscheint, erhalten unsere Mitglieder kostenlos.<br /><br />Das <a href="http://www.geo.uzh.ch/microsite/gegz/neu/vortraege/programm.html">Vortragsprogramm</a>, das jeweils auf einen thematischen Schwerpunkt gerichtet ist, beginnt jeweils im Oktober und schliesst mit einem Referat anlässlich der Hauptversammlung im Februar. Die Vorträge finden jeweils am Mittwochabend um 18.15 Uhr im Hauptgebäude der ETH statt. Zusätzlich werden die Mitglieder der GEGZ zum «Zürcher Geographischen Kolloquium», einer wissenschaftlichen Vortragsserie der Geographischen Institute der Universität und der ETH Zürich, eingeladen.<br /><br /> Die Gesellschaft organisiert für ihre Mitglieder Führungen und Besichtigungen sowie – vorwiegend im Sommerhalbjahr – ein- und mehrtägige Exkursionen im In- und Ausland.</p>',
	'members':          ['Norman Backhaus']
},{
	'name':        	    'Off-Spaces Schweiz',
	'short':            'OFFs',
	'claim':            '',
